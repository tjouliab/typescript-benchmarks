...
describe("convertIsoToCompact", () => {
  it("should return the date well formatted for ISO format", () => {
    const result = convertIsoToCompact("2024-01-10T23:05:33Z");

    const dateMoment = moment.utc("2024-01-10T23:05:33Z");
    const expected = formatToCompact(dateMoment);

    expect(result).toEqual(expected);
  });

  it("should return the date well formatted for ISO format with ms", () => {
  ...
  it("should return the date well formatted for the Bigtable format with ms", () => {
    const result = convertIsoToCompact("2024-01-10 23:05:33.123 [UTC]");

    const expected = "20240110230533.123";
...
describe("convertMomentToCompactDate", () => {
  it("should convert the moment date to CompactDate", () => {
    const isoDate = "2024-01-10T23:05:33Z";
  ...
  it("should convert the moment date to CompactDate with ms", () => {
    const isoDate = "2024-01-10T23:05:33.000Z";
    const momentDate = moment.utc(isoDate);
